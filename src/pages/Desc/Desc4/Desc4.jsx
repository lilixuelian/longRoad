      ...
      <View className='Desc'>
        ...
        >
          ...
          <View> 　　红军三渡赤水，由遵义再进川南遵义战役后，蒋介石由汉口飞抵重庆坐镇指挥，并改以堡垒主义和重点进攻相结合的战法，企图南北夹击，围歼中央红军于遵义、鸭溪地区。其部署：川军3个旅由桐梓向遵义地区进攻；第9军2个师由重庆向松坎、新站地区推进，支援川军进攻遵义；
            第2纵队主力3个师进至仁怀、鲁班场地区，向遵义及其西北地区进攻}第3纵队4个旅进至大定（今大方）、黔西地区防堵；第4纵队一部集结于金沙、土城等地，阻止红军向西发展；第1纵队4个师位于乌江南岸，策应其他纵队作战。此外，第1路军第53师由镇远向石阡推进，湘军3个师沿乌江东岸筑堡，阻止红军东进。\n</View>
        ...
        <AtCard
          ...
          thumb={sense}
        >
          遵义会议结束了王明“左”倾教条主义路线在党中央的统治，确立了以毛泽东为代表的新的中央正确领导，把党的路线转到了马克思列宁主义的轨道上来。
          遵义会议，在中国革命的危急关头，挽救了党，挽救了红军，挽救了中国革命，是我党历史上一个生死攸关的转折点。遵义会议是中国共产党第一次独
          立自主地运用马列主义基本原理解决自己的路线、方针和政策的会议。它是中国共产党从幼年的党走上成熟的党的标志。从此，中国革命就在毛泽东为代表的正确路线指引下走上胜利发展的道路。
        </AtCard>
        <View>　</View>
      </View>
    )
